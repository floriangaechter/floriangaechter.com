...
<Image src={video_streaming_fast_network_cam} alt="Video Streaming Tab / Fast Network Cam" />

**Normal Mode**
<Image src={video_streaming} alt="Video Streaming Tab" />
...
<Image src={lovelace} alt="Lovelace" />
