...
import video_streaming_fast_network_cam from "../../assets/video-streaming-fast-network-cam.png"
import video_streaming from "../../assets/video-streaming.png"
...
<Image src={video_streaming_fast_network_cam} alt="Screenshot showing Fast Network Cam mode" />

**Normal Mode**
<Image src={video_streaming} alt="Screenshot showing normal mode" />
...
<Image src={lovelace} alt="Screenshot of the Lovelace dashboard showing the camera stream" />
