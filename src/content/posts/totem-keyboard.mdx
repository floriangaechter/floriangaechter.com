...
import totemKeymap from "../../assets/totem-keymap.svg";
...
<Image src={totem} alt="Photo of the Totem keyboard" loading="eager" />
...
<Image src={totemKeymap} alt="Overview of my Totem keymap" />
