...
<Image src={unsecured} alt="Screenshot of the address bar of an unsecured website" loading="eager" />
...
<Image src={certificates} alt="Screenshot of the two generated certificates" />
...
<Image src={secured} alt="Screenshot of the address bar of a secured website" />
