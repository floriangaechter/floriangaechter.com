...
ogImage: "/src/assets/loading-timber-at-southampton-docks.jpg"
---

import Info from "src/components/Info.astro";

<Info title="Update January 6, 2021">
    I realized the multi-file upload example had some errors in it. They’re fixed now, and everything should be working as expected.
</Info>
